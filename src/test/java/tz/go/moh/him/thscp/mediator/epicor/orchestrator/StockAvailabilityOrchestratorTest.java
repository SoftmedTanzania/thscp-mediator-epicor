...
public class StockAvailabilityOrchestratorTest extends BaseTest{
    /**
    ...
    public void testMediatorHTTPRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = StockAvailabilityOrchestratorTest.class.getClassLoader().getResourceAsStream("stock-availability-request.json");

            assertNotNull(stream);


            createActorAndSendRequest(system, testConfig, getRef(), IOUtils.toString(stream), StockAvailabilityOrchestrator.class, "/stock-availability");
    ...
    public void testInValidPayload() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = StockAvailabilityOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-stock-availability-request.json");
            ...
            assertTrue(responseMessage.contains(String.format(thscpErrorMessageResource.getString("GENERIC_ERR"), "district")));
        }};
    }
    ...
    public void testInvalidDates() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = StockAvailabilityOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-dates-stock-availability-request.json");
