...
public class PercentageHealthFacilitiesStaffOrchestratorTest extends BaseTest{
    ...
    public void testMediatorHTTPRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = PercentageHealthFacilitiesStaffOrchestratorTest.class.getClassLoader().getResourceAsStream("percentage-health-facilities-staff-request.json");

            assertNotNull(stream);


            createActorAndSendRequest(system, testConfig, getRef(), IOUtils.toString(stream), PercentageHealthFacilitiesStaffOrchestrator.class, "/percentage-health-facilities-staff");
    ...
    public void testInValidPayload() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = PercentageHealthFacilitiesStaffOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-percentage-health-facilities-staff-request.json");
    ...
    public void testInvalidDates() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = PercentageHealthFacilitiesStaffOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-dates-percentage-health-facilities-staff-request.json");
