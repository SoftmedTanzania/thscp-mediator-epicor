...
public class ProcurementSupplyPlanOrchestratorTest extends BaseTest {
    ...
    public void testMediatorHTTPRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            ...
            createActorAndSendRequest(system, testConfig, getRef(), IOUtils.toString(stream), ProcurementSupplyPlanOrchestrator.class, "/procurement-supply-plan");
    ...
    public void testInValidPayload() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = ProcurementSupplyPlanOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-procurement-supply-plan-request.json");
    ...
    public void testInvalidDates() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = ProcurementSupplyPlanOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-dates-procurement-supply-plan-request.json");
