...
public class ItemFillRateOrchestratorTest extends BaseTest{
    ...
    public void testMediatorHTTPRequest() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = ItemFillRateOrchestratorTest.class.getClassLoader().getResourceAsStream("item-fill-rate-request.json");

            assertNotNull(stream);


            createActorAndSendRequest(system, testConfig, getRef(), IOUtils.toString(stream), ItemFillRateOrchestrator.class, "/item-fill-rate");
    ...
    public void testInValidPayload() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = ItemFillRateOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-item-fill-rate-request.json");
            ...
            assertTrue(responseMessage.contains(String.format(thscpErrorMessageResource.getString("GENERIC_ERR"), "deliveryDate")));
        }};
    }
    ...
    public void testInvalidDates() throws Exception {
        ...
        new JavaTestKit(system) {{
            InputStream stream = ItemFillRateOrchestratorTest.class.getClassLoader().getResourceAsStream("invalid-dates-item-fill-rate-request.json");
            ...
            assertEquals(400, responseStatus);
            assertTrue(responseMessage.contains(String.format(String.format(thscpErrorMessageResource.getString("ERROR_DATE_IS_NOT_VALID_PAST_DATE"),"deliveryDate"), "2024-05-05")));
            assertTrue(responseMessage.contains(String.format(String.format(thscpErrorMessageResource.getString("ERROR_DATE_IS_NOT_VALID_PAST_DATE"),"orderDate"), "2024-05-05")));
        }};
